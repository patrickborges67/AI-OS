...
```bash
cd .ai/skills/google-ads-ratos/scripts

# Verifica o que falta
python3 setup.py check

# Preencha CLIENT_ID, CLIENT_SECRET e DEVELOPER_TOKEN no .ai/skills/.env
...
Crie o arquivo `.ai/skills/.env` com:
...
```
google-ads-ratos/
├── SKILL.md              # Orquestrador (instrucoes pro Codex)
