...
```bash
test -f .ai/skills/meta-ads-ratos/contas.yaml && echo "META_TEM_CONTAS"
test -f .ai/skills/google-ads-ratos/contas.yaml && echo "GOOGLE_TEM_CONTAS"
test -f .ai/skills/ga4-ratos/contas.yaml && echo "GA4_TEM_CONTAS"
```
...
```bash
cat .ai/skills/meta-ads-ratos/contas.yaml
cat .ai/skills/google-ads-ratos/contas.yaml
cat .ai/skills/ga4-ratos/contas.yaml
```
...
**Arquivo:** `aprendizados.md` (na raiz da skill, `.ai/skills/ads-ratos/aprendizados.md`)
...
```bash
$PYTHON .ai/skills/meta-ads-ratos/scripts/read.py accounts
```
...
```bash
# Meta Ads
test -f .ai/skills/meta-ads-ratos/SKILL.md && echo "META_OK"

# Google Ads
test -f .ai/skills/google-ads-ratos/SKILL.md && echo "GOOGLE_OK"

# GA4
test -f .ai/skills/ga4-ratos/SKILL.md && echo "GA4_OK"
```

Se nenhuma skill estiver instalada em `.ai/skills/`, verificar o fallback `~/.claude/skills/`.
