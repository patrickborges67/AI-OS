...
_ENV_SEARCH_PATHS = [
    os.path.join(os.getcwd(), ".ai", "skills", ".env"),
    os.path.join(os.getcwd(), ".ai", "skills", "ga4-ratos", ".env"),
...
_GOOGLE_ADS_ENV_PATHS = [
    os.path.join(os.getcwd(), ".ai", "skills", ".env"),
    os.path.join(os.getcwd(), ".ai", "skills", "google-ads-ratos", ".env"),
]
...
def init_client():
    ...
    print("  Crie o arquivo .ai/skills/.env", file=sys.stderr)
    ...
    def wrapper(*args, **kwargs):
        ...
        try:
            ...
            if "invalid_scope" in error_str:
                error_data["hint"] = (
                    "O refresh token OAuth nao tem escopo GA4. Gere credenciais com "
                    "https://www.googleapis.com/auth/analytics.readonly ou use Service Account."
                )
